...
#
# site: https://github.com/FabianoLandimDev/Projeto-Pessoal-Secundario/tree/main/APP_LIt_Embarque/
#
...
#
# v1.0.2_2024-01-18, Fabiano Landim:
# - Mudanças em algumas linhas do código, referente algumas lojas que foram desligadas do TRJFA, inclusão de algumasnovas informações sobre guichês no interior do terminal.
#
# Licença: MIT.
#
